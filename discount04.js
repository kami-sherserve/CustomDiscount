...
// ----- Inject CSS to make country selector stack vertically and full width -----
...
function setupCheckoutElement(el) {
    ...
    el.addEventListener('click', (event) => {
        ...
        if (originalClick) {
            ...
            // anchor: do nothing - default navigation will happen
        }
        // For buttons with type="submit", the form will submit naturally
    });
}

...
function insertSelectorOnCartPage() {
    ...
    if (!checkoutButton) checkoutButton = document.querySelector('button[name="checkout"]');
...
function insertSelectorInModal() {
    ...
    const modalForm = document.querySelector('cart-notification .cart-notification__links form');

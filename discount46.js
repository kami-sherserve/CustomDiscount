...
function insertSelectorOnCartPage() {
    ...
    checkoutButton = document.querySelector('button[name="checkout"], input[name="checkout"]');
    if (!checkoutButton) checkoutButton = document.querySelector('.cart__ctas .cart__checkout-button');

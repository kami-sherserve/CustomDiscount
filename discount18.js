...
function injectCustomStyles() {
    ...
    style.textContent = `
        @media screen and (min-width: 750px) {
            ...
            /* New styles for cart__submit-controls */
...
function insertSelectorOnCartPage() {
    ...
    if (!checkoutButton) {
        checkoutButton = document.querySelector('.cart__footer input[name="checkout"]');
    }

    if (!checkoutButton) {
        checkoutButton = document.querySelector('.cart__footer button[name="checkout"]');
    }

    if (!checkoutButton) {
        checkoutButton = document.querySelector('.cart__submit-controls [name="checkout"]');
    }
    if (!checkoutButton) {
        checkoutButton = document.querySelector('.cart__buttons-container [name="checkout"]');
    }
    if (!checkoutButton) {
        checkoutButton = document.querySelector('#main-cart-footer .cart__submit');
    }
